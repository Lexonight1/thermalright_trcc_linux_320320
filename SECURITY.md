...
1. If the vulnerability is high/critical or may expose sensitive data, open a private issue (if supported) or contact the maintainers by email at: security@thermalright.example (replace with actual contact).
